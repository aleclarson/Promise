...
var FULFILLED, PENDING, Promise, PromiseTracer, PureObject, REJECTED, StubTracer, Tracer, Type, assertType, bind, emptyFunction, has, hasKeys, immediate, isDev, isType, sync, type;
...
type.defineValues(function() {
  return {
    ...
    _results: [void 0],
    _queue: [],
    _tracer: isDev ? StubTracer : void 0
  };
});
