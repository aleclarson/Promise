...
var DEFERRED, FULFILLED, PENDING, Promise, PureObject, REJECTED, Tracer, Type, assertType, bind, emptyFunction, has, hasKeys, immediate, isType, sync, type;
...
type.replaceArgs(function(args) {
  if (this !== global) {
